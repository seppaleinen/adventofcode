Feature: Day Seven
  ...
  Scenario: Example 1
    Given day007 input is
      | 123 -> x  |
    When solving day007
    Then day007 should expect '{x:123}'
  ...
  Scenario: Example 2
    Given day007 input is
      ...
      | x AND y -> d    |
    When solving day007
    Then day007 should expect '{d:72, x:123, y:456}'
  ...
  Scenario: Example 3
    Given day007 input is
      ...
      | x OR y -> e    |
    When solving day007
    Then day007 should expect '{e:507, x:123, y:456}'
  ...
  Scenario: Example 4
    Given day007 input is
      ...
      | x LSHIFT 2 -> f    |
    When solving day007
    Then day007 should expect '{f:492, x:123, y:456}'
  ...
  Scenario: Example 5
    Given day007 input is
      ...
      | y RSHIFT 2 -> g    |
    When solving day007
    Then day007 should expect '{g:114, x:123, y:456}'
  ...
  Scenario: Example 6
    Given day007 input is
      ...
      | NOT x -> h         |
    When solving day007
    Then day007 should expect '{h:65412, x:123, y:456}'
  ...
  Scenario: Example 7
    Given day007 input is
      ...
      | NOT y -> i         |
    When solving day007
    Then day007 should expect '{i:65079, x:123, y:456}'
  ...
  Scenario: Example 8
    Given day007 input is
      ...
      | NOT y -> i      |
    When solving day007
    Then day007 should expect '{d:72, e:507, f:492, g:114, h:65412, i:65079, x:123, y:456}'
  ...
  Scenario: Solve
    Given day007 input is
      ...
      |   NOT hn -> ho |
    When solving day007
    Then day007 should expect '{a:72}'
